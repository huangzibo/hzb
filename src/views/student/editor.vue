  ...
  <div class="dashboard-container">
    <el-form ref="form" :model="form" label-width="80px">
      ...
      <el-form-item label="所属学院">
        <el-select v-model="form.academy" placeholder="请选择"  @change="academyChange">
          <el-option
      ...
      <el-form-item label="学号">
        <el-input type="Number" v-model="form.student_number"></el-input>
      </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      academyChange(_id){
        //显示学院选择栏目
        this.$http.post('/api/classs/get',{academy:_id}).then(res => {
          this.classs = res
        })
      }
    },
